...
| get a menu of what to learn here | "what's there to learn in this repo" | rebuild-to-own (pulls the other two) |
| own what a sprint just built | "build me a syllabus from what we just shipped" | rebuild-to-own (pulls the other two) |
| continue an open track | "resume my <repo> rebuild" | rebuild-to-own (pulls the other two) |
| be graded | "committed - grade it" | rebuild-to-own (pulls the other two) |
