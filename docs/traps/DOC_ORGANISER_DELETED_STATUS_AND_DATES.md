...
`skills/learn-with-reps-gsd/SKILL.md` states the prohibition directly:
...
- Run `skills/learn-with-reps-gsd/profile-housekeeping.md` and nothing else. It is
...
`skills/learn-with-reps-gsd/ref/profile-schema.md`. If it does not — if it infers
